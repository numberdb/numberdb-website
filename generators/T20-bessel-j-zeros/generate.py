"""Zeros of Bessel functions of the first kind -- numberdb.org/T20

The n-th positive zero of J_alpha(x), for alpha in halves and n = 1..50.
...
mpmath computes the zeros of J at a working precision and returns a float with no
...
class BesselJZeros(numberdb.Generator):
    ...
    def _zero(alpha, n, working_digits):
        """The n-th the zeros of J of order alpha, as a string of that many digits.
        ...
        return mpmath.nstr(mpmath.mp.besseljzero(order, n, derivative=0), working_digits,
                           strip_zeros=False)


if __name__ == '__main__':
    generator = BesselJZeros()
