"""Values of Bi' at rational arguments -- numberdb.org/T203
...
class AiryBiPrimeValues(numberdb.Generator):

    table = os.environ.get("NUMBERDB_TABLE") or "T203"
    parameters = ("x",)
    type = "R"
    digits = 100
    rigour = "proven"
