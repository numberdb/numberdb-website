"""Local extrema of the Airy function Ai -- numberdb.org/T57

The n-th local extremum of Ai(x), for n = 1..1000.
...
mpmath computes the extrema of Ai at a working precision and returns a float with no
...
class AiryAiExtrema(numberdb.Generator):
    ...
    def _zero(n, working_digits):
        """The n-th the extrema of Ai, as a string of that many digits.
        ...
        return mpmath.nstr(mpmath.mp.airyaizero(n, derivative=1), working_digits,
                           strip_zeros=False)


if __name__ == '__main__':
    generator = AiryAiExtrema()
