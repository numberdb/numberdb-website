"""Local extrema of Bessel functions of the second kind -- numberdb.org/T23

The n-th local extremum of Y_alpha(x), for alpha in halves and n = 1..50.
...
mpmath computes the extrema of Y at a working precision and returns a float with no
...
class BesselYExtrema(numberdb.Generator):
    ...
    def _zero(alpha, n, working_digits):
        """The n-th the extrema of Y of order alpha, as a string of that many digits.
        ...
        return mpmath.nstr(mpmath.mp.besselyzero(order, n, derivative=1), working_digits,
                           strip_zeros=False)


if __name__ == '__main__':
    generator = BesselYExtrema()
