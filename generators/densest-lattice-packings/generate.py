...
LATTICE = {
    ...
    26: r'$\Lambda_{26}$ and of the lattice $T_{26}$',
    ...
    32: r"Quebbemann's lattice $Q_{32}$ CITE{Quebbemann}, one of several lattices of this density CITE{Catalogue-density}",
