...
class ImaginaryErrorFunctionValues(numberdb.Generator):

    table = os.environ.get("NUMBERDB_TABLE") or "T205"
    parameters = ("x",)
    type = "R"
    digits = 100
    rigour = "proven"
...
if __name__ == "__main__":
    _key_from_stdin()
    generator = ImaginaryErrorFunctionValues()
    if os.environ.get("NUMBERDB_PUBLISH") == "1" or "--publish" in sys.argv:
        print(generator.publish(
            message="values of erfi(x) at rational arguments"))
    else:
