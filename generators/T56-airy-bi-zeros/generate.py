"""Zeros of the Airy function Bi -- numberdb.org/T56

The n-th negative zero of Bi(x), for n = 1..1000.
...
mpmath computes the zeros of Bi at a working precision and returns a float with no
...
class AiryBiZeros(numberdb.Generator):
    ...
    def _zero(n, working_digits):
        """The n-th the zeros of Bi, as a string of that many digits.
        ...
        return mpmath.nstr(mpmath.mp.airybizero(n, derivative=0), working_digits,
                           strip_zeros=False)


if __name__ == '__main__':
    generator = AiryBiZeros()
