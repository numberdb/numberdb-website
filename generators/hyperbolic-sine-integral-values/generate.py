"""Values of the hyperbolic sine integral -- numberdb.org/T194
...
#
# So: every argument of two decimal places up to 10. Shi grows like e^x/2x, so ten is where a hundred digits still
# describes a number somebody reads rather than an exponent.
STEP = QQ(1) / QQ(100)
MAX_ARGUMENT = 10
