...
class FresnelSineIntegralValues(numberdb.Generator):

    table = os.environ.get("NUMBERDB_TABLE") or "T207"
    parameters = ("x",)
    type = "R"
    digits = 100
    rigour = "proven"
...
if __name__ == "__main__":
    _key_from_stdin()
    generator = FresnelSineIntegralValues()
    if os.environ.get("NUMBERDB_PUBLISH") == "1" or "--publish" in sys.argv:
        print(generator.publish(
            message="values of S(x) at rational arguments"))
    else:
